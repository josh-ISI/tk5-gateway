//HERC01G  JOB (GCC),'HELLO WORLD C',CLASS=A,MSGCLASS=Z,REGION=4096K,
...
//         DD DSN=HERC01.PDPCLIB.MACLIB,DISP=SHR
...
int main(void)
{
    printf("Hello from GCC on MVS 3.8 TK5!\n");
    printf("Compiled, linked and run by a job submitted from a PC.\n");
    return (0);
}
/*
